...
public class SmsProperties {
    ...
    private String tplOrderOkForOwner; // 3.5月12日19点30分中潭路4号口不见不散（当用户预约并支付成功时收到的提醒）
    private String tplOrderOkForUser; // 3.5月12日19点30分中潭路4号口不见不散（当用户预约并支付成功时收到的提醒）
    ...
    private String tplOwnerFail; // 9.您已经通过车主失败
